...
myKeys conf@(XConfig {XMonad.modMask = super}) = M.fromList $
    ...
    -- launch applications
    , ((super, xK_e), file_manager)
    , ((super, xK_v), text_editor)
...
-- ## Layout Hook ## ----------------------------------------------------------------------
myLayoutHook = gaps [(L,0), (R,0), (U,0), (D,0)] $ spacingRaw False (Border 10 0 10 0) True (Border 0 10 0 10) True $ myLayout
